...
public class Archer extends Unit {
  ...
  private static final double[][] ARCHER_VAlUES = { { 60, 0.4, 0.5, 0.6 }, { 60, 0.4, 0.5, 0.6 },
      { 70, 0.5, 0.6, 0.7 } };
  protected static final double[] ARCHER_TARGET_FACTORS = { 0.3, 0.4, 0.5 };
  protected static final double[] INFANTRY_TARGET_FACTORS = { 0.2, 0.3, 0.4 };
  protected static final double[] CAVALRY_TARGET_FACTORS = { 0.1, 0.1, 0.2 };
